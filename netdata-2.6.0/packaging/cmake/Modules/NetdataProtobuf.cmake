...
function(netdata_bundle_protobuf)
        ...
        if(NEED_ABSL)
                ...
                set(absl_SOURCE_DIR "${CMAKE_CURRENT_BINARY_DIR}/_deps/absl-src")
                ...
                if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.28)
                    FetchContent_Declare(absl
                            ...
                            PATCH_COMMAND ${CMAKE_CURRENT_SOURCE_DIR}/packaging/cmake/patches/apply-patches.sh
                                        ${absl_SOURCE_DIR}
                                        ${CMAKE_CURRENT_SOURCE_DIR}/packaging/cmake/patches/abseil
...
function(netdata_protoc_generate_cpp PROTO_ROOT_DIR OUTPUT_ROOT_DIR GENERATED_SOURCES GENERATED_HEADERS)
    ...
    if(ENABLE_BUNDLED_PROTOBUF)
        list(APPEND protoc_include_paths ${CMAKE_CURRENT_BINARY_DIR}/_deps/protobuf-src/src/)
    endif()
